...
<div class="row">
	...
	<div class="col-12">
		...
		<div class="col-12 product-image-thumbs">
			<div class="product-image-thumb" id="img1"><img src="../resources/images/prod-1.jpg" alt="Product Image"></div>
		...
		<div>
			<a href="/shop/createPost?${_csrf.parameterName}=${_csrf.token}" class="btn btn-primary" style="float:right;">상품등록</a>
		</div>
