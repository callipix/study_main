		...
		<div class="card-body row">
			<div
				...
				<div class="">
					...
					<p class="lead mb-5">
						<img alt="" src="/resources/upload${contactInfoVO.ciImgUrl}" style="width: 100%">
			...
			<div class="col-7">
				<div class="form-group">
					...
					<form:input path="ciName" class="form-control" value="${contactInfoVO.ciName}" />
					<code><form:errors path="ciName" /></code>
				</div>
				<div class="form-group">
					<label for="ciMail">이메일</label> 
					<form:input path="ciMail" class="form-control" value="${contactInfoVO.ciMail}" />
					<code><form:errors path="ciMail" /></code>
				</div>
				<div class="form-group">
					<label for="ciSubj">방문 주제</label> 
					<form:input path="ciSubj" class="form-control" value="${contactInfoVO.ciSubj}" />
				...
				<div class="form-group">
					...
					<div id="ckCiMesg">
					<img alt="" src="/resources/upload${contactInfoVO.ciMesg}" style="width: 100%">
					</div>
					<textarea name="ciMesg" id="ciMesg" class="form-control" rows="4"></textarea>
				</div>
				<div class="form-group">
					<label for="ciRegDt">방문자 예정일</label> 
					<input type="date" name="ciRegDt" id="ciRegDt" class="form-control" value='<fmt:formatDate value="${contactInfoVO.ciRegDt}" pattern="yyyy-MM-dd" />' />	
