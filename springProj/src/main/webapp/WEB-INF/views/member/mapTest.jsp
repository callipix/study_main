...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=cad3b7bcccf1d223b9d90752e2d3c559"></script>
<script>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = {
        center: new kakao.maps.LatLng(36.325147570815275 , 127.40879040840275), // 지도의 중심좌표
        level: 4 // 지도의 확대 레벨
    };  
